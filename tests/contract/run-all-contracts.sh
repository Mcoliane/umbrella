...
TESTS=(
  ...
  "$ROOT/tests/contract/test-upgrade-preserves-config.sh"
  ...
  "$ROOT/tests/contract/test-session-operator-profile.sh"
  "$ROOT/tests/contract/test-memory-promotion-sweep.sh"
